$(document).ready(function () {
    ...
    self.showPrivateMessages = function () {
        // Cập nhật danh sách người dùng cho modal
        self.privateMessageUsers(self.filteredChatUsers());
    };
    self.privateMessageUsers = ko.observableArray([]);
